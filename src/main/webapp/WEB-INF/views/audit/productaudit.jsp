...
<div class="row search">
    ...
    <div class="col-md-2">
        <button type="button" class="btn btn-primary" style="float: left;"
                data-toggle="modal" data-target="#createEquipment" >权限申请</button>
    </div>
    <div class="col-md-4">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="crdateModalLabel">权限申请</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="productName" class="col-md-4 control-label">申请模块</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="type" class="col-md-4 control-label">申请类型</label>
                        <div class="col-md-6">
                            <select id="type" class="form-control" name="type">
                                <option value="-1">请选择</option>
                                <option value="1">使用权</option>
                                <option value="2">编辑权</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="applyTime" class="col-md-4 control-label">申请时限</label>
                        <div class="col-md-6">
                            <select id="applyTime" class="form-control" name="applyTime">
                                <option value="-1">请选择</option>
                    ...
                    <div class="form-group">
                        <label for="applyReason" class="col-md-4 control-label">申请理由</label>
                        <div class="col-md-6">
                            <textarea name="message"class="form-control" placeholder="请输入您的申请理由。。。" id="applyReason" cols=35 rows=5 ></textarea>
                            <br>
                        </div>
                    </div>
    ...
    $("#createForm")
        .submit(
            function (e) {
                ...
                var reason = $.trim($("#applyReason").val());
                ...
                $
                    .ajax({
                        url: "${pageContext.request.contextPath}/productline/createauditrecord",
                        type: "post",
