...
public class Test {
    ...
    /**
     * http://agile.baidu.com/agile/pipelineConf/getPipelineBranchInfo?module=baidu/baidunuomi/account根据模块路径获取模块的pipeline信息
     * http://agile.baidu.com/agile/pipeline/getPipelineBuilds?pipelineConfId=468301&branch=chenyiwen_pay-platform-gateway&offset=0&limit=10
     * 根据pipelineId和分支信息获取分支的构建列表
     * http://agile.baidu.com/agile/commitInfo?triggerId=10007021&compileBuildId=10242727&isGitModule=true
     * 根据分支信息中获取的compileBuildId和triggerId获取buildResult
     *
     */
